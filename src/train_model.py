...
def main():
    ...
    with mlflow.start_run(run_name="xgboost_production_model"):
        ...
        mlflow.log_params({"model_type": "XGBClassifier", "n_estimators": 200, "max_depth": 10, "tree_method": "hist", "device": "cuda"})
        ...
        print(f"XGBoost (GPU) logged to MLflow. Accuracy: {xgb_metrics['accuracy']:.4f}")
